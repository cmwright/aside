...
inputs=(ios/Pipeline/RecordingSounds.swift ios/Shared/AsideIPC.swift ios/Pipeline/MessagesHistory.swift ios/Pipeline/DictationPipeline.swift ios/scripts/check-provider-routing.swift)
